...
banker_case_lists = [
    ...
    (
        ...
        {'uid': uids[6], 'buyer': {'1': [20, 10]}, 'ret': [94, -10, 0]},
        {'uid': uids[7], 'buyer': {'1': 10}, 'ret': [47, -10, 0]},
        {'uid': uids[8], 'buyer': {'1': [100, 10]}, 'ret': [47, -10, 0]},
        {'uid': uids[9], 'buyer': {'1': 200}, 'ret': [95, -200, 0]},

        {'uid': uids[10], 'buyer': {'2': [11, 10]}, 'ret': [-10, 94, 0]},
        {'uid': uids[11], 'buyer': {'2': 10}, 'ret': [-10, 47, 0]},
        {'uid': uids[12], 'buyer': {'2': [100, 10]}, 'ret': [-10, 47, 0]},
        {'uid': uids[13], 'buyer': {'2': 200}, 'ret': [-200, 95, 0]},
